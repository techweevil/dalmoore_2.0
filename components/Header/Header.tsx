...
const Header = () => {
  return (
    <div className="md:sticky relative top-0 z-[2] shadow-md">
      <div className="bg-primary w-full   lg:h-[33.5px] md:text-right lg:pr-[8rem] md:pr-[5em] flex md:justify-end items-center justify-center font-monts">
